package com.github.zharovvv.android.core.sandbox.navigation.fragment2
...
class Fragment2 : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        with(binding) {
            ...
            textViewFragment.text = getString(R.string.title_fragment2)
            buttonFragmentBack.setOnClickListener { navController.popBackStack() }
            buttonFragmentNext.setOnClickListener { navController.navigate(R.id.fragment3) }
        }
    }
